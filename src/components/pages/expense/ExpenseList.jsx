    ...
    return (
        <div className="w-full min-h-screen">
                    ...
                    <div className=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-3 rounded-lg text-black dark:text-white bg-white dark:bg-black border border-gray-300 dark:border-gray-500 placeholder:text-gray-400 outline-none focus:ring-2 focus:ring-blue-500 focus:border-none"
                                />
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full rounded-lg text-black dark:text-white bg-white dark:bg-black border border-gray-300 dark:border-gray-500 placeholder:text-gray-400 px-4 py-3  outline-none focus:ring-2 focus:ring-blue-500 focus:border-none"
                            >
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full rounded-lg text-black dark:text-white dark:bg-black border border-gray-300 dark:border-gray-500 px-4 py-3 bg-white outline-none focus:ring-2 focus:ring-blue-500 focus:border-none"
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border text-black dark:text-white bg-white dark:bg-black border-gray-300 dark:border-gray-500 px-4 py-3 outline-none focus:ring-2 focus:ring-blue-500 focus:border-none"
                            />
            ...
            {!loading && expenses.length === 0 ? (
                ...
                <div
                    className="bg-white dark:bg-black rounded-xl shadow-sm border border-gray-200 dark:border-gray-500 overflow-hidden">
                    ...
                    <ConfirmModal
                        ...
                        onLoadingButtonText='Deleting Expense...'
                    />
